      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              Creating unforgettable moments through exceptional event
              experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <span>Khalpar kacha Bazar,Sonargaon Janapath,uttra, Dhaka,</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg
                  className="h-5 w-5"
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>+01938-456778, 01839-3765889</span>
              </li>
            </ul>
          </div>
