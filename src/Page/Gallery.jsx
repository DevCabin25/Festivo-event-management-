...
const Gallery = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60",
      ...
      <div className="bg-gradient-to-r from-blue-500 to-purple-500 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className=" text-white mb-4">
            Let us create a beautiful and memorable event that you'll be proud
            to showcase. <br /> Contact us today to start planning.
          </p>
          <a
            href="/contact"
